...
public class AddMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addData(nama, harga,jenis, image);
            }
    ...
    private void addData(String nama, String harga, String jenis, byte[] image) {
        boolean insertData = dataHelper.addMenu(nama,harga, jenis, image);
        if(insertData){
            Toast("Data Masuk");
            Intent intent = new Intent(AddMenu.this, ManageFood.class);
